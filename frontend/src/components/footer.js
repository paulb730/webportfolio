...
const Footer=()=>{
    ...
    const children=[
        [
            {   type:"img",
                props:{
                    src:"https://images.pexels.com/photos/323645/pexels-photo-323645.jpeg",
    ...
    [   {
        type:"img",
        props:{
            src:"https://images.pexels.com/photos/7046979/pexels-photo-7046979.jpeg",
            className:"card-img-top",
            style:{width:"auto"}   },
        children:null
        },
